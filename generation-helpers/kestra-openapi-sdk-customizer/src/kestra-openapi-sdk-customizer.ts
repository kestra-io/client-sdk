...
async function run(confPath: string, inputPath: string, outputPath?: string) {
    ...
    const dumped = yaml.dump(spec, {
        lineWidth: 120,
        noRefs: true,
        quoteStyle: "double", // ← forces double quotes (js-yaml >= 5 renamed `quotingType`)
    });
    const commented = `# This file was generated by kestra-openapi-sdk-customizer
# Do not edit this file directly. Instead, edit the original spec
# and run the customizer to regenerate this file.

${dumped}`;
    await fs.writeFile(out, commented, "utf8");
