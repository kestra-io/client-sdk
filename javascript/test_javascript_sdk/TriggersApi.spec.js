...
describe("TriggersApiTest", () => {
    it("deleteBackfillTest", async () => {
        ...
        const resp = await kestraClient().triggersApi.deleteBackfill(
            MAIN_TENANT,
            t,
        );
    ...
    it("deleteBackfillByIdsTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.deleteBackfillByIds(
            MAIN_TENANT,
            [t],
        );
        expect(resp).toBeTruthy();
    ...
    it("deleteBackfillByQueryTest", async () => {
        ...
        const resp = await kestraClient().triggersApi.deleteBackfillByQuery(
            MAIN_TENANT,
            {
                filters: [
                    {
    ...
    it("disabledTriggersByIdsTest", async () => {
        ...
        const resp = await kestraClient().triggersApi.disabledTriggersByIds(
            MAIN_TENANT,
            req,
        );
        expect(resp).toBeTruthy();
    ...
    it("pauseBackfillTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.pauseBackfill(
            MAIN_TENANT,
            t,
        );
        expect(resp).toBeTruthy();
    ...
    it("pauseBackfillByIdsTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.pauseBackfillByIds(
            MAIN_TENANT,
            [t],
        );
        expect(resp).toBeTruthy();
    ...
    it("pauseBackfillByQueryTest", async () => {
        ...
        const resp = await kestraClient().triggersApi.pauseBackfillByQuery(
            MAIN_TENANT,
            {
                filters: [
                    {
    ...
    it("restartTriggerTest", async () => {
        ...
        const resp = await kestraClient().triggersApi.restartTrigger(
            namespace,
            flowId,
            triggerId,
            MAIN_TENANT,
    ...
    it("unlockTriggerTest", async () => {
        ...
        await expectRejectStatus(
            kestraClient().triggersApi.unlockTrigger(
                namespace,
                flowId,
                triggerId,
                MAIN_TENANT,
    ...
    it("unlockTriggersByIdsTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.unlockTriggersByIds(
            MAIN_TENANT,
            [t],
        );
        expect(resp).toBeTruthy();
    ...
    it("unlockTriggersByQueryTest", async () => {
        ...
        const resp =
            await kestraClient().triggersApi.unlockTriggersByQuery(MAIN_TENANT);
        expect(resp).toBeTruthy();
    });
    ...
    it("unpauseBackfillTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.unpauseBackfill(
            MAIN_TENANT,
            t,
        );
        expect(resp).toBeTruthy();
    ...
    it("unpauseBackfillByIdsTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.unpauseBackfillByIds(
            MAIN_TENANT,
            [t],
        );
        expect(resp).toBeTruthy();
    ...
    it("unpauseBackfillByQueryTest", async () => {
        ...
        const resp =
            await kestraClient().triggersApi.unpauseBackfillByQuery(
                MAIN_TENANT,
            );
        expect(resp).toBeTruthy();
    });
    ...
    it("updateTriggerTest", async () => {
        ...
        const t = triggerRef(namespace, flowId, triggerId);
        const resp = await kestraClient().triggersApi.updateTrigger(
            MAIN_TENANT,
            t,
        );
        expect(resp).toBeTruthy();
