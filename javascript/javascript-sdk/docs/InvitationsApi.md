...
apiInstance.createInvitation(tenant, iAMInvitationControllerApiInvitationCreateRequest).then(() => {
...
let id = "id_example"; // String | The id of the invitation
let tenant = "tenant_example"; // String | 
apiInstance.invitation(id, tenant).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
let tenant = "tenant_example"; // String | 
apiInstance.listInvitationsByEmail(email, tenant).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> PagedResultsIAMInvitationControllerApiInvitationDetail searchInvitations(page, size, filters, tenant, opts)
...
apiInstance.searchInvitations(page, size, filters, tenant, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
