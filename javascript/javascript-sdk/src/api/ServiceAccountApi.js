...
export default class ServiceAccountApi {
    ...
    */
    listServiceAccountsWithHttpInfo(filters, opts) {
      opts = opts || {};
      let postBody = null;
    ...
    * @return {Promise<PagedResultsIAMServiceAccountControllerApiServiceAccountDetail>}
    */
    listServiceAccounts(filters, opts) {
      return this.listServiceAccountsWithHttpInfo(filters, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    */
    serviceAccountWithHttpInfo(id) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling serviceAccount");
      }
    ...
    */
    serviceAccountForTenantWithHttpInfo(id, tenant) {
      ...
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling serviceAccountForTenant");
      }
      // verify the required parameter 'tenant' is set
      if (tenant === undefined || tenant === null) {
        throw new Error("Missing the required parameter 'tenant' when calling serviceAccountForTenant");
      }
