...
export default class FlowsApi {
    ...
    */
    exportFlowsWithHttpInfo(filters, tenant) {
      let postBody = null;
      // verify the required parameter 'filters' is set
      if (filters === undefined || filters === null) {
        throw new Error("Missing the required parameter 'filters' when calling exportFlows");
      }
      // verify the required parameter 'tenant' is set
      if (tenant === undefined || tenant === null) {
        throw new Error("Missing the required parameter 'tenant' when calling exportFlows");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{tenant}/flows/export/by-query/csv', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
    ...
    * @return {Promise< Array.<Object> >}
    */
    exportFlows(filters, tenant) {
      return this.exportFlowsWithHttpInfo(filters, tenant)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
