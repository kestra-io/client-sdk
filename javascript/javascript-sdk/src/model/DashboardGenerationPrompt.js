...
/**
  * @typedef {Object} IDashboardGenerationPrompt
...
/**
 * The DashboardGenerationPrompt model module.
 * @module model/DashboardGenerationPrompt
 * @type {IDashboardGenerationPrompt}
 */
class DashboardGenerationPrompt {
    /**
     * Constructs a new <code>DashboardGenerationPrompt</code>.
     * @alias module:model/DashboardGenerationPrompt
    ...
    /**
     * Constructs a <code>DashboardGenerationPrompt</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DashboardGenerationPrompt} obj Optional instance to populate.
     * @return {module:model/DashboardGenerationPrompt} The populated <code>DashboardGenerationPrompt</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DashboardGenerationPrompt();
    ...
    /**
     * Validates the JSON data with respect to <code>DashboardGenerationPrompt</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DashboardGenerationPrompt</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DashboardGenerationPrompt.RequiredProperties) {
...
DashboardGenerationPrompt.RequiredProperties = ["conversationId", "userPrompt"];
...
export default DashboardGenerationPrompt;
