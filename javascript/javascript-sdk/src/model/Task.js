...
/**
  ...
  * @property {Object} retry - Retry policy applied when the task fails.
...
class Task {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('timeout')) {
                obj['timeout'] = Object.constructFromObject(data['timeout']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['timeout']) { // data not null
          Object.validateJSON(data['timeout']);
        }
