...
/**
  ...
  * @property {Object} retry - Retry policy applied when the flow fails.
  * @property {Array.<module:model/SLA>} sla
  * @property {Array.<module:model/Check>} checks - A list of conditions that are evaluated before the flow is executed.  If no checks are defined, the flow executes normally.
 ...
 * @member {Date} updated
 */
FlowWithSource.prototype['updated'] = undefined;
 ...
 */
FlowWithSource.prototype['checks'] = undefined;

/**
 * @member {String} source
 */
FlowWithSource.prototype['source'] = undefined;
 ...
 * @member {Array.<module:model/Check>} checks
 */
Flow.prototype['checks'] = undefined;
