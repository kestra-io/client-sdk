...
class DailyExecutionStatisticsExecutionCounts {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('RESUBMITTED')) {
                obj['RESUBMITTED'] = ApiClient.convertToType(data['RESUBMITTED'], 'Number');
            }
        }
        return obj;
    }
 ...
 */
DailyExecutionStatisticsExecutionCounts.prototype['SUBMITTED'] = undefined;
...
/**
 * @member {Number} RESUBMITTED
 */
DailyExecutionStatisticsExecutionCounts.prototype['RESUBMITTED'] = undefined;
