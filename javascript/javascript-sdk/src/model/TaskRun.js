...
class TaskRun {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('assets')) {
                obj['assets'] = ApiClient.convertToType(data['assets'], AssetsInOut);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['assets']) { // data not null
          AssetsInOut.validateJSON(data['assets']);
        }
...
/**
 * @member {module:model/AssetsInOut} assets
 */
TaskRun.prototype['assets'] = undefined;
