    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('gracePeriod')) {
                obj['gracePeriod'] = ApiClient.convertToType(data['gracePeriod'], 'Date');
            }
        }
        return obj;
    }
 ...
 */
MiscControllerLicenseInfo.prototype['online'] = undefined;

/**
 * @member {Date} gracePeriod
 */
MiscControllerLicenseInfo.prototype['gracePeriod'] = undefined;
