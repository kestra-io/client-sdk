...
/**
  ...
  * @property {MiscControllerTenantConfigurationInfo} tenants
...
class MiscControllerEEConfiguration {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('chartDefaultDuration')) {
                obj['chartDefaultDuration'] = ApiClient.convertToType(data['chartDefaultDuration'], 'String');
            }
            ...
            if (data.hasOwnProperty('isConcurrencyViewEnabled')) {
                obj['isConcurrencyViewEnabled'] = ApiClient.convertToType(data['isConcurrencyViewEnabled'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('airgapped')) {
                obj['airgapped'] = ApiClient.convertToType(data['airgapped'], 'Boolean');
            }
            if (data.hasOwnProperty('featureGating')) {
                obj['featureGating'] = ApiClient.convertToType(data['featureGating'], 'Boolean');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['chartDefaultDuration'] && !(typeof data['chartDefaultDuration'] === 'string' || data['chartDefaultDuration'] instanceof String)) {
            throw new Error("Expected the field `chartDefaultDuration` to be a primitive type in the JSON string but got " + data['chartDefaultDuration']);
        }
...
/**
 * @member {String} chartDefaultDuration
 */
MiscControllerEEConfiguration.prototype['chartDefaultDuration'] = undefined;
...
/**
 * @member {Boolean} isConcurrencyViewEnabled
 */
MiscControllerEEConfiguration.prototype['isConcurrencyViewEnabled'] = undefined;
...
/**
 * @member {Boolean} airgapped
 */
MiscControllerEEConfiguration.prototype['airgapped'] = undefined;

/**
 * @member {Boolean} featureGating
 */
MiscControllerEEConfiguration.prototype['featureGating'] = undefined;
 ...
 * @member {String} chartDefaultDuration
 */
MiscControllerConfiguration.prototype['chartDefaultDuration'] = undefined;
/**
 * @member {Date} commitDate
 */
 ...
 * @member {Boolean} isConcurrencyViewEnabled
 */
MiscControllerConfiguration.prototype['isConcurrencyViewEnabled'] = undefined;
