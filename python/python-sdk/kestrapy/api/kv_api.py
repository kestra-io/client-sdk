...
class KVApi:
    ...
    def list_all_keys(
        ...
        filters: Annotated[Optional[List[QueryFilter]], Field(description="Filters. PHP-style nested query is used - example: `filters[namespace][IN]=company.team`")] = None,
        _request_timeout: Union[
        None,
        Annotated[StrictFloat, Field(gt=0)],
        Tuple[
        ...
        :type sort: List[str]
                :param filters: Filters. PHP-style nested query is used - example: `filters[namespace][IN]=company.team`
