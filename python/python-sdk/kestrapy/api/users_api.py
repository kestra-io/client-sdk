...
class UsersApi:
    ...
    def list_users(
        ...
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True)]], Field(description="The current page size")] = None,
    ...
    @validate_call
    def patch_user_instance_owner(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        api_patch_instance_owner_request: ApiPatchInstanceOwnerRequest,
        _request_timeout: Union[
        None,
        Annotated[StrictFloat, Field(gt=0)],
        Tuple[
        ...
        :param id: The user id (required)
        :type id: str
                :param api_patch_instance_owner_request: (required)
        :type api_patch_instance_owner_request: ApiPatchInstanceOwnerRequest
        ,
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._patch_user_instance_owner_serialize(
            id=id,
            api_patch_instance_owner_request=api_patch_instance_owner_request,
        )
    ...
    @validate_call
    def patch_user_instance_owner_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        api_patch_instance_owner_request: ApiPatchInstanceOwnerRequest,
        _request_timeout: Union[
    ...
    def _patch_user_instance_owner_serialize(
        self,
        id,
        api_patch_instance_owner_request,
    ) -> RequestSerialized:
        ...
        # process the form parameters
        # process the body parameter
        if api_patch_instance_owner_request is not None:
            _body_params = api_patch_instance_owner_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v1/users/{id}/instanceowner',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_user_instance_owner_legacy(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        ...
        """(Deprecated) Update user instance-owner privileges (deprecated)
        ...
        :type _request_timeout: int, tuple(int, int), optional
        """ # noqa: E501
        warnings.warn("PATCH /api/v1/users/{id}/superadmin is deprecated.", DeprecationWarning)

        _param = self._patch_user_instance_owner_legacy_serialize(
            id=id,
    ...
    @validate_call
    def patch_user_instance_owner_legacy_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        api_patch_super_admin_request: ApiPatchSuperAdminRequest,
        _request_timeout: Union[
    ...
    def _patch_user_instance_owner_legacy_serialize(
        self,
        id,
