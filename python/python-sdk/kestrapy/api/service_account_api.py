...
class ServiceAccountApi:
    ...
    @validate_call
    def list_service_accounts_for_tenant(
        self,
        tenant: StrictStr,
        page: Annotated[Optional[StrictInt], Field(description="The current page")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True)]], Field(description="The current page size")] = None,
        ...
        _param = self._list_service_accounts_for_tenant_serialize(
            tenant=tenant,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def list_service_accounts_for_tenant_with_http_info(
        self,
        tenant: StrictStr,
        page: Annotated[Optional[StrictInt], Field(description="The current page")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True)]], Field(description="The current page size")] = None,
    ...
    def _list_service_accounts_for_tenant_serialize(
        self,
        tenant,
        page,
        size,
    ...
    @validate_call
    def patch_service_account_instance_owner(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        ...
        _param = self._patch_service_account_instance_owner_serialize(
            id=id,
    ...
    @validate_call
    def patch_service_account_instance_owner_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        api_patch_instance_owner_request: ApiPatchInstanceOwnerRequest,
        _request_timeout: Union[
    ...
    def _patch_service_account_instance_owner_serialize(
        self,
        id,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v1/service-accounts/{id}/instanceowner',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_service_account_instance_owner_legacy(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        ...
        """(Deprecated) Update service account instance-owner privileges (deprecated)
        ...
        :type _request_timeout: int, tuple(int, int), optional
        """ # noqa: E501
        warnings.warn("PATCH /api/v1/service-accounts/{id}/superadmin is deprecated.", DeprecationWarning)

        _param = self._patch_service_account_instance_owner_legacy_serialize(
            id=id,
    ...
    @validate_call
    def patch_service_account_instance_owner_legacy_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The user id")],
        api_patch_super_admin_request: ApiPatchSuperAdminRequest,
        _request_timeout: Union[
    ...
    def _patch_service_account_instance_owner_legacy_serialize(
        self,
        id,
