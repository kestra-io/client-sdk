...
class ExecutionMetadata(BaseModel):
    ...
    concurrency_scopes: Optional[List[StrictStr]] = Field(default=None, alias="concurrencyScopes")
    execution_depth: Optional[StrictInt] = Field(default=None, alias="executionDepth")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attemptNumber", "originalCreatedDate", "concurrencyScopes", "executionDepth"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "concurrencyScopes": obj.get("concurrencyScopes"),
            "executionDepth": obj.get("executionDepth")
        })
