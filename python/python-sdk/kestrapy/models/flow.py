...
class Flow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "namespace", "revision", "updated", "description", "inputs", "outputs", "disabled", "draft", "labels", "variables", "workerSelector", "deleted", "finally", "tasks", "errors", "afterExecution", "triggers", "policyRefs", "concurrency", "retry", "sla", "checks", "quotas"]
