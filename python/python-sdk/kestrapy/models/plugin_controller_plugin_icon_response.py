...
class PluginControllerPluginIconResponse(BaseModel):
    """
    PluginControllerPluginIconResponse
    """ # noqa: E501
    icon: Optional[PluginIcon] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "icon": PluginIcon.from_dict(obj["icon"]) if obj.get("icon") is not None else None
        })
