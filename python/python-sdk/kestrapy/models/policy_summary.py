...
class PolicySummary(BaseModel):
    ...
    rules: Optional[PolicyRuleSummary] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "displayName", "description", "scope", "namespace", "target", "enforcement", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target": PolicyTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
            "enforcement": obj.get("enforcement"),
            "rules": PolicyRuleSummary.from_dict(obj["rules"]) if obj.get("rules") is not None else None
        })
