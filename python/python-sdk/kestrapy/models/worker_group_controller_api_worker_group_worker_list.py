...
class WorkerGroupControllerApiWorkerGroupWorkerList(BaseModel):
    """
    WorkerGroupControllerApiWorkerGroupWorkerList
    """ # noqa: E501
    workers: Optional[List[WorkerGroupControllerApiWorkerGroupWorker]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workers": [WorkerGroupControllerApiWorkerGroupWorker.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None
        })
