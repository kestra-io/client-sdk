...
class Execution(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["labels", "id", "namespace", "flowId", "flowRevision", "taskRunList", "inputs", "variables", "state", "parentId", "originalId", "trigger", "deleted", "metadata", "scheduleDate", "traceParent", "fixtures", "kind", "breakpoints", "loopRun"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if loop_run (nullable) is None
        # and model_fields_set contains the field
        if self.loop_run is None and "loop_run" in self.model_fields_set:
            _dict['loopRun'] = None
...
Execution.model_rebuild(raise_errors=False)
