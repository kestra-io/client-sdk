...
class SourceSearchReplaceLineRequest(BaseModel):
    """
    ...
    column: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["query", "caseSensitive", "wholeWord", "regex", "replacement", "namespace", "id", "line", "column"]
