...
class FlowForExecution(BaseModel):
    ...
    labels: Optional[MapObjectObject] = Field(default=None, description="Labels as a list of Label (key/value pairs) or as a map of string to string.")
    ...
    __properties: ClassVar[List[str]] = ["id", "namespace", "revision", "updated", "description", "inputs", "outputs", "disabled", "draft", "labels", "variables", "workerSelector", "deleted", "tasks", "errors", "finally", "afterExecution", "triggers"]
