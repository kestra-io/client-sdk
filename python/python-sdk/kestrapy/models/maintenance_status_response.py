...
class MaintenanceStatusResponse(BaseModel):
    ...
    services: Optional[MaintenanceStatusResponseServices] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["maintenance", "ready", "services"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ready": obj.get("ready"),
            "services": MaintenanceStatusResponseServices.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
