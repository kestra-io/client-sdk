...
class UnitTest(BaseModel):
    ...
    expected_state: Optional[StateType] = Field(default=None, alias="expectedState")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "disabled", "description", "fixtures", "assertions", "expectedState"]
