...
class WorkerGroupControllerApiWorkerGroupTokenSummary(BaseModel):
    """
    ...
    token_prefix: Optional[StrictStr] = Field(default=None, alias="tokenPrefix")
    ...
    __properties: ClassVar[List[str]] = ["uid", "name", "description", "tokenPrefix", "createdAt", "expiresAt", "useCount", "revoked", "valid"]
