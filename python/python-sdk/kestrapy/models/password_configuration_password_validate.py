...
class PasswordConfigurationPasswordValidate(BaseModel):
    """
    PasswordConfigurationPasswordValidate
    """ # noqa: E501
    cooldown: Optional[StrictStr] = 'PT5M'
    rate_limit: Optional[PasswordConfigurationRateLimit] = Field(default=None, alias="rateLimit")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cooldown", "rateLimit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cooldown": obj.get("cooldown") if obj.get("cooldown") is not None else 'PT5M',
            "rateLimit": PasswordConfigurationRateLimit.from_dict(obj["rateLimit"]) if obj.get("rateLimit") is not None else None
        })
