...
class AssetsControllerApiAsset(BaseModel):
    ...
    lock: Optional[AssetsControllerApiAssetLock] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["namespace", "id", "type", "displayName", "description", "metadata", "created", "updated", "deleted", "lock"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if lock (nullable) is None
        # and model_fields_set contains the field
        if self.lock is None and "lock" in self.model_fields_set:
            _dict['lock'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lock": AssetsControllerApiAssetLock.from_dict(obj["lock"]) if obj.get("lock") is not None else None
        })
