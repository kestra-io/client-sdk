...
class ExpressionContext(BaseModel):
    ...
    ExpressionContext
    """ # noqa: E501
    categories: Optional[ExpressionContextCategories] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": ExpressionContextCategories.from_dict(obj["categories"]) if obj.get("categories") is not None else None
        })
