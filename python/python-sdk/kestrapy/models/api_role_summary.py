...
class ApiRoleSummary(BaseModel):
    ...
    permission_count: Optional[StrictInt] = Field(default=None, alias="permissionCount")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "isDefault", "isManaged", "permissionCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissionCount": obj.get("permissionCount")
        })
