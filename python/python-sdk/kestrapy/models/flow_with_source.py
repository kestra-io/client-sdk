...
class FlowWithSource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "namespace", "revision", "updated", "description", "inputs", "outputs", "disabled", "labels", "variables", "workerGroup", "deleted", "finally", "tasks", "errors", "afterExecution", "triggers", "concurrency", "retry", "sla", "checks", "source"]
