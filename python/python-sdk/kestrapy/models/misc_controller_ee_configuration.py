...
class MiscControllerEEConfiguration(BaseModel):
    ...
    flow_template: Optional[StrictStr] = Field(default=None, alias="flowTemplate")
    ...
    is_plugin_auto_install_enabled: Optional[StrictBool] = Field(default=None, alias="isPluginAutoInstallEnabled")
    ...
    support_enabled: Optional[StrictBool] = Field(default=None, alias="supportEnabled")
    ...
    worker_auth_enabled: Optional[StrictBool] = Field(default=None, alias="workerAuthEnabled")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uuid", "version", "edition", "commitId", "chartDefaultDuration", "flowTemplate", "commitDate", "isCustomDashboardsEnabled", "isAnonymousUsageEnabled", "isUiAnonymousUsageEnabled", "environment", "url", "preview", "systemNamespace", "hiddenLabelsPrefixes", "isAiEnabled", "isAiApiKeyConfigured", "isBasicAuthInitialized", "pluginsHash", "isPluginAutoInstallEnabled", "tenants", "secretsEnabled", "supportedStorages", "supportedSecrets", "pluginManagementEnabled", "pluginCustomEnabled", "banner", "mailServiceEnabled", "outputsInInternalStorageEnabled", "leftSidebar", "rightSidebar", "supportEnabled", "inMaintenance", "passwordConfiguration", "passwordlessEnabled", "airgapped", "featureGating", "features", "killSwitches", "workerAuthEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flowTemplate": obj.get("flowTemplate"),
            ...
            "isPluginAutoInstallEnabled": obj.get("isPluginAutoInstallEnabled"),
            ...
            "workerAuthEnabled": obj.get("workerAuthEnabled")
        })
