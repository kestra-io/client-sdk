...
class SourceSearchReplacePreviewResponseFlowMatches(BaseModel):
    """
    ...
    matches: Optional[List[SourceSearchReplacePreviewResponseMatch]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["namespace", "id", "editable", "matches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [SourceSearchReplacePreviewResponseMatch.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None
        })
