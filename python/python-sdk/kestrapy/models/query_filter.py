...
class QueryFilter(BaseModel):
    ...
    logical: Optional[QueryFilterLogical] = None
    children: Optional[List[QueryFilter]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["field", "operation", "value", "logical", "children"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "children": [QueryFilter.from_dict(_item) for _item in obj["children"]] if obj.get("children") is not None else None
        })
