...
class WorkerGroupControllerApiSubscriptionCapacity(BaseModel):
    """
    WorkerGroupControllerApiSubscriptionCapacity
    """ # noqa: E501
    worker_queue_id: Optional[StrictStr] = Field(default=None, alias="workerQueueId")
    allocated: Optional[StrictInt] = None
    used: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["workerQueueId", "allocated", "used"]
