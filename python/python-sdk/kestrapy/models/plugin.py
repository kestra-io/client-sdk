...
class Plugin(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "title", "description", "license", "longDescription", "group", "version", "manifest", "guides", "aliases", "tasks", "triggers", "controllers", "storages", "secrets", "taskRunners", "apps", "appBlocks", "charts", "dataFilters", "dataFiltersKPI", "logExporters", "additionalPlugins", "categories", "subGroup"]
