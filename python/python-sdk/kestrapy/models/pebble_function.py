...
class PebbleFunction(BaseModel):
    """
    PebbleFunction
    """ # noqa: E501
    name: Optional[StrictStr] = None
    arguments: Optional[List[PebbleFunctionArgument]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "arguments": [PebbleFunctionArgument.from_dict(_item) for _item in obj["arguments"]] if obj.get("arguments") is not None else None
        })
