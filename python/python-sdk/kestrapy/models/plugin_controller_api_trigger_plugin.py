...
class PluginControllerApiTriggerPlugin(BaseModel):
    """
    PluginControllerApiTriggerPlugin
    """ # noqa: E501
    type: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    plugin_title: Optional[StrictStr] = Field(default=None, alias="pluginTitle")
    description: Optional[StrictStr] = None
    group: Optional[TriggerPluginCategory] = None
    ee: Optional[StrictBool] = None
    icon: Optional[StrictStr] = None
    deprecated: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "name", "pluginTitle", "description", "group", "ee", "icon", "deprecated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "name": obj.get("name"),
            "pluginTitle": obj.get("pluginTitle"),
