...
class PolicyRuleSummary(BaseModel):
    ...
    PolicyRuleSummary
    """ # noqa: E501
    mutate: Optional[StrictInt] = None
    var_validate: Optional[StrictInt] = Field(default=None, alias="validate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["mutate", "validate"]
