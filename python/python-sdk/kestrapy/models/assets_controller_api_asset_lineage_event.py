...
class AssetsControllerApiAssetLineageEvent(BaseModel):
    """
    ...
    outputs: Optional[List[AssetIdentifier]] = None
    created: Optional[datetime] = None
    start_date: Optional[datetime] = Field(default=None, alias="startDate")
    end_date: Optional[datetime] = Field(default=None, alias="endDate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uid", "namespace", "flowId", "flowRevision", "executionId", "taskId", "taskRunId", "state", "inputs", "outputs", "created", "startDate", "endDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputs": [AssetIdentifier.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None,
