...
class ApiLightExecution(BaseModel):
    """
    ApiLightExecution
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "id", "namespace", "flowId", "flowRevision", "inputs", "labels", "state", "parentId", "originalId", "trigger", "scheduleDate", "kind", "loopRun"]
