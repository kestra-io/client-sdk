...
class PasswordConfigurationRateLimit(BaseModel):
    """
    PasswordConfigurationRateLimit
    """ # noqa: E501
    max_requests: Optional[StrictInt] = Field(default=10, alias="maxRequests")
    window: Optional[StrictStr] = 'PT1H'
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["maxRequests", "window"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maxRequests": obj.get("maxRequests") if obj.get("maxRequests") is not None else 10,
            "window": obj.get("window") if obj.get("window") is not None else 'PT1H'
        })
