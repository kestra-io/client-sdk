...
class Role(BaseModel):
    ...
    permissions: Optional[ListPermissions200Response] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": ListPermissions200Response.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
