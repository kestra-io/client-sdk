...
class PluginUiModuleWithGroup(BaseModel):
    """
    PluginUiModuleWithGroup
    """ # noqa: E501
    ui_module: Optional[StrictStr] = Field(default=None, alias="uiModule")
    group: Optional[StrictStr] = None
    static_info: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, alias="staticInfo")
    styles: Optional[List[StrictStr]] = None
    source_hash: Optional[StrictStr] = Field(default=None, alias="sourceHash")
    distribution: Optional[PluginDistribution] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uiModule", "group", "staticInfo", "styles", "sourceHash", "distribution"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uiModule": obj.get("uiModule"),
            "group": obj.get("group"),
            "staticInfo": obj.get("staticInfo"),
