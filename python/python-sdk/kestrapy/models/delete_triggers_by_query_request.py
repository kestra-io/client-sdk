...
class DeleteTriggersByQueryRequest(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[List[QueryFilter]] = Field(default=None, description="Filters. PHP-style nested query is used - examples: `filters[flowId][EQUALS]=hello-world`, `filters[namespace][CONTAINS]=test`")
