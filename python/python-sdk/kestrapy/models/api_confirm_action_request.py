...
class ApiConfirmActionRequest(BaseModel):
    """
    ApiConfirmActionRequest
    """ # noqa: E501
    confirmation_id: Optional[StrictStr] = Field(default=None, alias="confirmationId")
    decision: Optional[ApiDecision] = None
    reason: Optional[StrictStr] = None
    provider_id: Optional[StrictStr] = Field(default=None, alias="providerId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["confirmationId", "decision", "reason", "providerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "confirmationId": obj.get("confirmationId"),
