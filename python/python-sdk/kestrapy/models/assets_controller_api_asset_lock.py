...
class AssetsControllerApiAssetLock(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["lockedUntil", "acquiredAt", "ownerType", "executionId", "flowId", "flowNamespace", "namespace", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lockedUntil": obj.get("lockedUntil"),
