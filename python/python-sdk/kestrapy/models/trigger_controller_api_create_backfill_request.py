...
class TriggerControllerApiCreateBackfillRequest(BaseModel):
    """
    ...
    backfill: Optional[TriggerControllerApiCreateBackfillRequestBackfill] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["namespace", "flowId", "triggerId", "backfill"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "backfill": TriggerControllerApiCreateBackfillRequestBackfill.from_dict(obj["backfill"]) if obj.get("backfill") is not None else None
        })
