...
class ApiGroupSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "securityIntegrationName"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if security_integration_name (nullable) is None
        # and model_fields_set contains the field
        if self.security_integration_name is None and "security_integration_name" in self.model_fields_set:
            _dict['securityIntegrationName'] = None
