...
class MaintenanceStatusResponseServiceStatus(BaseModel):
    """
    MaintenanceStatusResponseServiceStatus
    """ # noqa: E501
    total: Optional[StrictInt] = None
    in_maintenance: Optional[StrictInt] = Field(default=None, alias="inMaintenance")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["total", "inMaintenance"]
