...
class KillSwitch(BaseModel):
    ...
    execution_ids: Optional[List[StrictStr]] = Field(default=None, alias="executionIds")
    start_date: datetime = Field(alias="startDate")
    end_date: Optional[datetime] = Field(default=None, alias="endDate")
    description: Optional[StrictStr] = None
    evaluation_type: EvaluationType = Field(alias="evaluationType")
    enabled: Optional[StrictBool] = None
    deleted: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "tenantId", "namespace", "flowId", "executionIds", "startDate", "endDate", "description", "evaluationType", "enabled", "deleted"]
