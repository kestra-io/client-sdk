...
class ApiFlowHashBatchResponse(BaseModel):
    """
    ApiFlowHashBatchResponse
    """ # noqa: E501
    results: Optional[List[ApiFlowHashBatchResult]] = Field(default=None, description="Per-flow results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ApiFlowHashBatchResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
