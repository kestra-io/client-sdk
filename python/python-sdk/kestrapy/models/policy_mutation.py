...
class PolicyMutation(BaseModel):
    ...
    """ # noqa: E501
    action: Optional[ApiPolicyMutationAction] = None
    target: Optional[StrictStr] = None
    value: Optional[Dict[str, Any]] = None
    previous_value: Optional[Dict[str, Any]] = Field(default=None, alias="previousValue")
    policy_id: Optional[StrictStr] = Field(default=None, alias="policyId")
    scope: Optional[Scope] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["action", "target", "value", "previousValue", "policyId", "scope"]
