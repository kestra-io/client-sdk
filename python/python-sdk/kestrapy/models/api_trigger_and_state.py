...
class ApiTriggerAndState(BaseModel):
    """
    ApiTriggerAndState
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["trigger", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "trigger": AbstractTrigger.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None,
            "state": ApiTriggerState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
