...
class ExecutionControllerExecutionAverageDuration(BaseModel):
    """
    ExecutionControllerExecutionAverageDuration
    """ # noqa: E501
    avg_duration_ms: Optional[StrictInt] = Field(default=None, alias="avgDurationMs")
    count: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["avgDurationMs", "count"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if avg_duration_ms (nullable) is None
        # and model_fields_set contains the field
        if self.avg_duration_ms is None and "avg_duration_ms" in self.model_fields_set:
            _dict['avgDurationMs'] = None
