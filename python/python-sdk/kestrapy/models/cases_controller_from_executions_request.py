...
class CasesControllerFromExecutionsRequest(BaseModel):
    """
    CasesControllerFromExecutionsRequest
    """ # noqa: E501
    case: CasesControllerCaseCreateRequest
    execution_ids: List[StrictStr] = Field(alias="executionIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["case", "executionIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "case": CasesControllerCaseCreateRequest.from_dict(obj["case"]) if obj.get("case") is not None else None,
