...
class TenantControllerAppsCatalogConfigResponse(BaseModel):
    ...
    tile_color: Optional[StrictStr] = Field(default=None, alias="tileColor")
    button_text_color: Optional[StrictStr] = Field(default=None, alias="buttonTextColor")
    logo: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "titleColor", "primaryColor", "backgroundColor", "tileColor", "buttonTextColor", "logo"]
