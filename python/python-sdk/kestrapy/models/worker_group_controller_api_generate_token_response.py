...
class WorkerGroupControllerApiGenerateTokenResponse(BaseModel):
    """
    WorkerGroupControllerApiGenerateTokenResponse
    """ # noqa: E501
    token: Optional[StrictStr] = None
    details: Optional[WorkerGroupControllerApiWorkerGroupTokenSummary] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["token", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": obj.get("token"),
            "details": WorkerGroupControllerApiWorkerGroupTokenSummary.from_dict(obj["details"]) if obj.get("details") is not None else None
        })
