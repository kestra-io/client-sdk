...
class LogEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["namespace", "flowId", "taskId", "executionId", "taskRunId", "attemptNumber", "triggerId", "timestamp", "level", "thread", "message", "executionKind", "progress"]
