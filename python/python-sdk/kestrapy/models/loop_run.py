...
class LoopRun(BaseModel):
    ...
    LoopRun
    """ # noqa: E501
    parent: Optional[Execution] = None
    ...
    parents: Optional[List[LoopRunParent]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["parent", "taskId", "taskRunId", "index", "key", "value", "parents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parent": Execution.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "taskId": obj.get("taskId"),
            "taskRunId": obj.get("taskRunId"),
            "index": obj.get("index"),
            "key": obj.get("key"),
            "value": obj.get("value"),
            "parents": [LoopRunParent.from_dict(_item) for _item in obj["parents"]] if obj.get("parents") is not None else None
        })
...
LoopRun.model_rebuild(raise_errors=False)
