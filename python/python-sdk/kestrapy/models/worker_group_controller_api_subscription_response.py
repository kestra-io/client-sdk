...
class WorkerGroupControllerApiSubscriptionResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    queue: Optional[WorkerGroupControllerApiWorkerQueueSummary] = None
    reserved_percent: Optional[StrictInt] = Field(default=None, alias="reservedPercent")
    mode: Optional[QueueSubscriptionMode] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["queue", "reservedPercent", "mode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queue": WorkerGroupControllerApiWorkerQueueSummary.from_dict(obj["queue"]) if obj.get("queue") is not None else None,
            "reservedPercent": obj.get("reservedPercent"),
            "mode": obj.get("mode")
        })
