...
class Counts200Response(BaseModel):
    """
    Counts200Response
    """ # noqa: E501
    open: Optional[StrictInt] = Field(default=None, alias="OPEN")
    acknowledged: Optional[StrictInt] = Field(default=None, alias="ACKNOWLEDGED")
    investigating: Optional[StrictInt] = Field(default=None, alias="INVESTIGATING")
    resolved: Optional[StrictInt] = Field(default=None, alias="RESOLVED")
    cancelled: Optional[StrictInt] = Field(default=None, alias="CANCELLED")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["OPEN", "ACKNOWLEDGED", "INVESTIGATING", "RESOLVED", "CANCELLED"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "INVESTIGATING": obj.get("INVESTIGATING"),
