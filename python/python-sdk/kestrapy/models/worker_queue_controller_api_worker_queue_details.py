...
class WorkerQueueControllerApiWorkerQueueDetails(BaseModel):
    """
    ...
    workers: Optional[List[ServiceInstance]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "tags", "allowedTenants", "workers"]
