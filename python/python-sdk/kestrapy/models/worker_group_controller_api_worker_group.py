...
class WorkerGroupControllerApiWorkerGroup(BaseModel):
    """
    ...
    subscriptions: Optional[List[WorkerGroupControllerApiSubscriptionResponse]] = None
    tokens: Optional[List[WorkerGroupControllerApiWorkerGroupTokenSummary]] = None
    deletable: Optional[StrictBool] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "subscriptions", "tokens", "deletable", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [WorkerGroupControllerApiSubscriptionResponse.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None,
            "tokens": [WorkerGroupControllerApiWorkerGroupTokenSummary.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
