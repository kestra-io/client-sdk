...
class PolicyEvaluation(BaseModel):
    ...
    PolicyEvaluation
    """ # noqa: E501
    counts: Optional[ApiPolicyEvaluationCounts] = None
    total: Optional[StrictInt] = None
    results: Optional[List[PolicyEvaluationResult]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["counts", "total", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": ApiPolicyEvaluationCounts.from_dict(obj["counts"]) if obj.get("counts") is not None else None,
            "total": obj.get("total"),
            "results": [PolicyEvaluationResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
