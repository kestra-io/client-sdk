...
class PluginInstallJobArtifactProgress(BaseModel):
    """
    PluginInstallJobArtifactProgress
    """ # noqa: E501
    resource: Optional[StrictStr] = None
    transferred: Optional[StrictInt] = None
    total: Optional[StrictInt] = None
    state: Optional[PluginInstallJobArtifactState] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["resource", "transferred", "total", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transferred": obj.get("transferred"),
            "total": obj.get("total"),
            "state": obj.get("state")
        })
