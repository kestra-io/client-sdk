...
class ApiFlowHashesResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    hashes: Optional[List[ApiFlowHashesResponseHash]] = Field(default=None, description="Per-flow source hashes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hashes": [ApiFlowHashesResponseHash.from_dict(_item) for _item in obj["hashes"]] if obj.get("hashes") is not None else None
        })
