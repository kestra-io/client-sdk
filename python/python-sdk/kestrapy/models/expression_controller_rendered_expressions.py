...
class ExpressionControllerRenderedExpressions(BaseModel):
    """
    ExpressionControllerRenderedExpressions
    """ # noqa: E501
    rendered: Optional[Dict[str, StrictStr]] = Field(default=None, description="Rendered values keyed by their raw expression")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["rendered"]
