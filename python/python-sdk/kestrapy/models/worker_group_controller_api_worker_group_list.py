...
class WorkerGroupControllerApiWorkerGroupList(BaseModel):
    """
    WorkerGroupControllerApiWorkerGroupList
    """ # noqa: E501
    worker_groups: Optional[List[WorkerGroupControllerApiWorkerGroup]] = Field(default=None, alias="workerGroups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workerGroups": [WorkerGroupControllerApiWorkerGroup.from_dict(_item) for _item in obj["workerGroups"]] if obj.get("workerGroups") is not None else None
        })
