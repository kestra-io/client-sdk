...
class ApiPromoteBatchResponse(BaseModel):
    """
    ApiPromoteBatchResponse
    """ # noqa: E501
    results: Optional[List[ApiPromoteFlowResult]] = Field(default=None, description="Per-flow results, in request order")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ApiPromoteFlowResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
