...
class WorkerGroupControllerApiCreateWorkerGroupRequest(BaseModel):
    """
    ...
    subscriptions: List[WorkerGroupControllerApiSubscriptionRequest]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [WorkerGroupControllerApiSubscriptionRequest.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
