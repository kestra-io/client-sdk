...
class WorkerCredentialControllerApiWorkerList(BaseModel):
    """
    WorkerCredentialControllerApiWorkerList
    """ # noqa: E501
    workers: Optional[List[WorkerCredentialControllerApiWorkerCredential]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workers": [WorkerCredentialControllerApiWorkerCredential.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None
        })
