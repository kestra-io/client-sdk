...
class McpServerControllerApiMcpToolAnnotations(BaseModel):
    """
    MCP tool behavioural annotations.
    """ # noqa: E501
    read_only: Optional[StrictBool] = Field(default=None, alias="readOnly")
    open_world: Optional[StrictBool] = Field(default=None, alias="openWorld")
    destructive: Optional[StrictBool] = None
    idempotent: Optional[StrictBool] = None
    return_direct: Optional[StrictBool] = Field(default=None, alias="returnDirect")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["readOnly", "openWorld", "destructive", "idempotent", "returnDirect"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "openWorld": obj.get("openWorld"),
            "destructive": obj.get("destructive"),
            "idempotent": obj.get("idempotent"),
            "returnDirect": obj.get("returnDirect")
        })
