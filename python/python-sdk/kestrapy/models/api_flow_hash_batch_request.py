...
class ApiFlowHashBatchRequest(BaseModel):
    """
    ApiFlowHashBatchRequest
    """ # noqa: E501
    flows: Annotated[List[ApiFlowHashBatchRef], Field(max_length=100)] = Field(description="The flows to fetch hashes for (max 100 per request)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flows": [ApiFlowHashBatchRef.from_dict(_item) for _item in obj["flows"]] if obj.get("flows") is not None else None
        })
