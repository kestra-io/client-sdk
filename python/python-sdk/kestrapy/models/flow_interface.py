...
class FlowInterface(BaseModel):
    ...
    worker_selector: Optional[WorkerSelector] = Field(default=None, alias="workerSelector")
    concurrency: Optional[Concurrency] = None
    quotas: Optional[List[Quota]] = None
    sla: Optional[List[SLA]] = None
    source: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "namespace", "revision", "tenantId", "deleted", "description", "disabled", "draft", "labels", "inputs", "outputs", "variables", "workerSelector", "concurrency", "quotas", "sla", "source"]
