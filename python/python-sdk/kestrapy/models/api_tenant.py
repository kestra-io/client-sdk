...
class ApiTenant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["storageIsolation", "secretIsolation", "id", "name", "deleted", "workerGroup", "storageType", "storageConfiguration", "secretType", "secretReadOnly", "secretConfiguration", "requireExistingNamespace", "outputsInInternalStorage", "appCatalogConfig", "settings", "sdkDefaultAuthentication", "logo"]
