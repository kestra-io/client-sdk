...
class ExecutionControllerApiValidateExecutionInputsResponseApiInputError(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr
    render_error: Optional[StrictBool] = Field(default=None, alias="renderError")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "renderError"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "renderError": obj.get("renderError")
        })
