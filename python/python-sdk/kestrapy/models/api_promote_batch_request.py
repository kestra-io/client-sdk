...
class ApiPromoteBatchRequest(BaseModel):
    """
    ApiPromoteBatchRequest
    """ # noqa: E501
    flows: Annotated[List[IdWithNamespace], Field(min_length=1, max_length=100)] = Field(description="The flows to promote (max 100 per request)")
    target_ids: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="The ids of the targets to promote every flow to", alias="targetIds")
    confirmed: Optional[StrictBool] = Field(default=None, description="Confirmation for gated targets")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["flows", "targetIds", "confirmed"]
