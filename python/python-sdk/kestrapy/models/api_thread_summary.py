...
class ApiThreadSummary(BaseModel):
    """
    ApiThreadSummary
    """ # noqa: E501
    ...
    last_turn_at: Optional[datetime] = Field(default=None, alias="lastTurnAt")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uid", "title", "mode", "status", "createdAt", "updatedAt", "lastTurnAt"]
