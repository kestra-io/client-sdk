...
class WorkerQueueControllerApiWorkerQueueItem(BaseModel):
    """
    ...
    active_workers: Optional[StrictInt] = Field(default=None, alias="activeWorkers")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "tags", "allowedTenants", "activeWorkers"]
