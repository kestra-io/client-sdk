...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.create_execution(namespace, tenant, id, wait=wait, schedule_date=schedule_date, breakpoints=breakpoints, kind=kind, labels=labels, revision=revision)
...
*ExecutionsApi* | [**eval_expression**](docs/ExecutionsApi.md#eval_expression) | **POST** /api/v1/{tenant}/executions/{executionId}/eval | Evaluate a variable expression for this execution
