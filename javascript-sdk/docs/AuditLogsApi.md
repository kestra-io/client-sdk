# KestraIoKestraApi.AuditLogsApi
...
let apiInstance = new KestraIoKestraApi.AuditLogsApi();
let tenant = "tenant_example"; // String | 
let auditLogControllerFindRequest = new KestraIoKestraApi.AuditLogControllerFindRequest(); // AuditLogControllerFindRequest | The find request
...
let opts = {
  ...
  'permission': new KestraIoKestraApi.Permission(), // Permission | A permission filter
  ...
  'type': new KestraIoKestraApi.CrudEventType() // CrudEventType | The event that create the audit log
};
