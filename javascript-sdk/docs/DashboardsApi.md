# KestraIoKestraApi.DashboardsApi
...
let apiInstance = new KestraIoKestraApi.DashboardsApi();
...
let apiInstance = new KestraIoKestraApi.DashboardsApi();
let tenant = "tenant_example"; // String | 
let dashboardControllerPreviewRequest = new KestraIoKestraApi.DashboardControllerPreviewRequest(); // DashboardControllerPreviewRequest | 
...
let tenant = "tenant_example"; // String | 
let chartFiltersOverrides = new KestraIoKestraApi.ChartFiltersOverrides(); // ChartFiltersOverrides | The filters to apply, some can override chart definition like labels & namespace
