...
let apiInstance = new KestraIoKestraApi.GroupsApi();
...
let apiInstance = new KestraIoKestraApi.GroupsApi();
let tenant = "tenant_example"; // String | 
let apiAutocomplete = new KestraIoKestraApi.ApiAutocomplete(); // ApiAutocomplete | Autocomplete request
...
let apiInstance = new KestraIoKestraApi.GroupsApi();
let tenant = "tenant_example"; // String | 
let iAMGroupControllerApiCreateGroupRequest = new KestraIoKestraApi.IAMGroupControllerApiCreateGroupRequest(); // IAMGroupControllerApiCreateGroupRequest | The group
...
let apiInstance = new KestraIoKestraApi.GroupsApi();
let tenant = "tenant_example"; // String | 
let apiIds = new KestraIoKestraApi.ApiIds(); // ApiIds | The ids that must be present on results
...
let membership = new KestraIoKestraApi.GroupIdentifierMembership(); // GroupIdentifierMembership | The new membership type to assign to the user.
let tenant = "tenant_example"; // String | 
...
let id = "id_example"; // String | The group id
let tenant = "tenant_example"; // String | 
let iAMGroupControllerApiUpdateGroupRequest = new KestraIoKestraApi.IAMGroupControllerApiUpdateGroupRequest(); // IAMGroupControllerApiUpdateGroupRequest | The group
