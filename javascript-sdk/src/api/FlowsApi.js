...
export default class FlowsApi {
    ...
    */
     ...
     */
    getFlowDependenciesWithHttpInfo(namespace, id, destinationOnly, tenant) {
      let postBody = null;
      // verify the required parameter 'namespace' is set
      if (namespace === undefined || namespace === null) {
     ...
     */
    getFlowDependencies(namespace, id, destinationOnly, tenant) {
      return this.getFlowDependenciesWithHttpInfo(namespace, id, destinationOnly, tenant)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
