...
class NamespaceWithDisabled {
    /**
     * Constructs a new <code>NamespaceWithDisabled</code>.
     * @alias module:model/NamespaceWithDisabled
    ...
    constructor(id, deleted) { 
        Namespace.initialize(this, id, deleted);NamespaceLight.initialize(this, id, deleted);
        NamespaceWithDisabled.initialize(this, id, deleted);
    }
    ...
    /**
     * Constructs a <code>NamespaceWithDisabled</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NamespaceWithDisabled} obj Optional instance to populate.
     * @return {module:model/NamespaceWithDisabled} The populated <code>NamespaceWithDisabled</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NamespaceWithDisabled();
    ...
    /**
     * Validates the JSON data with respect to <code>NamespaceWithDisabled</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NamespaceWithDisabled</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NamespaceWithDisabled.RequiredProperties) {
...
NamespaceWithDisabled.RequiredProperties = ["id", "deleted"];

/**
 * @member {String} id
 */
NamespaceWithDisabled.prototype['id'] = undefined;

/**
 * @member {Boolean} deleted
 */
NamespaceWithDisabled.prototype['deleted'] = undefined;

/**
 * @member {Array.<module:model/NamespaceAllowedTrigger>} allowedTriggers
 */
NamespaceWithDisabled.prototype['allowedTriggers'] = undefined;

/**
 * @member {module:model/Isolation} storageIsolation
 */
NamespaceWithDisabled.prototype['storageIsolation'] = undefined;

/**
 * @member {module:model/Isolation} secretIsolation
 */
NamespaceWithDisabled.prototype['secretIsolation'] = undefined;

/**
 * @member {String} description
 */
NamespaceWithDisabled.prototype['description'] = undefined;

/**
 * @member {Object.<String, Object>} variables
 */
NamespaceWithDisabled.prototype['variables'] = undefined;

/**
 * @member {Array.<module:model/PluginDefault>} pluginDefaults
 */
NamespaceWithDisabled.prototype['pluginDefaults'] = undefined;

/**
 * @member {Array.<module:model/NamespaceAllowedNamespace>} allowedNamespaces
 */
NamespaceWithDisabled.prototype['allowedNamespaces'] = undefined;

/**
 * @member {module:model/WorkerGroup} workerGroup
 */
NamespaceWithDisabled.prototype['workerGroup'] = undefined;

/**
 * @member {String} storageType
 */
NamespaceWithDisabled.prototype['storageType'] = undefined;

/**
 * @member {Object.<String, Object>} storageConfiguration
 */
NamespaceWithDisabled.prototype['storageConfiguration'] = undefined;

/**
 * @member {String} secretType
 */
NamespaceWithDisabled.prototype['secretType'] = undefined;

/**
 * @member {Boolean} secretReadOnly
 */
NamespaceWithDisabled.prototype['secretReadOnly'] = undefined;

/**
 * @member {Object.<String, Object>} secretConfiguration
 */
NamespaceWithDisabled.prototype['secretConfiguration'] = undefined;

/**
 * @member {Boolean} outputsInInternalStorage
 */
NamespaceWithDisabled.prototype['outputsInInternalStorage'] = undefined;

/**
 * @member {Boolean} disabled
 */
NamespaceWithDisabled.prototype['disabled'] = undefined;
...
export default NamespaceWithDisabled;
