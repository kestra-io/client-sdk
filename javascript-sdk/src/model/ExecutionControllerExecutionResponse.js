...
class ExecutionControllerExecutionResponse {
    ...
    /**
     * Constructs a <code>ExecutionControllerExecutionResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExecutionControllerExecutionResponse} obj Optional instance to populate.
     * @return {module:model/ExecutionControllerExecutionResponse} The populated <code>ExecutionControllerExecutionResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExecutionControllerExecutionResponse();
            Execution.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>ExecutionControllerExecutionResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExecutionControllerExecutionResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ExecutionControllerExecutionResponse.RequiredProperties) {
 ...
 */
ExecutionControllerExecutionResponse.prototype['labels'] = undefined;

/**
 * @member {String} id
 */
ExecutionControllerExecutionResponse.prototype['id'] = undefined;

/**
 * @member {String} namespace
 */
ExecutionControllerExecutionResponse.prototype['namespace'] = undefined;

/**
 * @member {String} flowId
 */
ExecutionControllerExecutionResponse.prototype['flowId'] = undefined;

/**
 * @member {Number} flowRevision
 */
ExecutionControllerExecutionResponse.prototype['flowRevision'] = undefined;

/**
 * @member {Array.<module:model/TaskRun>} taskRunList
 */
ExecutionControllerExecutionResponse.prototype['taskRunList'] = undefined;

/**
 * @member {Object.<String, Object>} inputs
 */
ExecutionControllerExecutionResponse.prototype['inputs'] = undefined;

/**
 * @member {Object.<String, Object>} outputs
 */
ExecutionControllerExecutionResponse.prototype['outputs'] = undefined;

/**
 * @member {Object.<String, Object>} variables
 */
ExecutionControllerExecutionResponse.prototype['variables'] = undefined;

/**
 * @member {module:model/State} state
 */
ExecutionControllerExecutionResponse.prototype['state'] = undefined;

/**
 * @member {String} parentId
 */
ExecutionControllerExecutionResponse.prototype['parentId'] = undefined;

/**
 * @member {String} originalId
 */
ExecutionControllerExecutionResponse.prototype['originalId'] = undefined;

/**
 * @member {module:model/ExecutionTrigger} trigger
 */
ExecutionControllerExecutionResponse.prototype['trigger'] = undefined;

/**
 * @member {Boolean} deleted
 */
ExecutionControllerExecutionResponse.prototype['deleted'] = undefined;

/**
 * @member {module:model/ExecutionMetadata} metadata
 */
ExecutionControllerExecutionResponse.prototype['metadata'] = undefined;

/**
 * @member {Date} scheduleDate
 */
ExecutionControllerExecutionResponse.prototype['scheduleDate'] = undefined;

/**
 * @member {String} traceParent
 */
ExecutionControllerExecutionResponse.prototype['traceParent'] = undefined;

/**
 * @member {Array.<module:model/TaskFixture>} fixtures
 */
ExecutionControllerExecutionResponse.prototype['fixtures'] = undefined;
...
export default ExecutionControllerExecutionResponse;
