...
public class PagedResultsTaskRun {
  ...
  @javax.annotation.Nonnull  private List<TaskRun> results = new ArrayList<>();
  ...
  public PagedResultsTaskRun results(@javax.annotation.Nonnull List<TaskRun> results) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setResults(@javax.annotation.Nonnull List<TaskRun> results) {
    this.results = results;
  }

  public PagedResultsTaskRun total(@javax.annotation.Nonnull Long total) {
