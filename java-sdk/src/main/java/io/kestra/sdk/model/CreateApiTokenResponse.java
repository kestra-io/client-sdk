...
public class CreateApiTokenResponse {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `fullToken` to the URL query string
    if (getFullToken() != null) {
      try {
        joiner.add(String.format("%sfullToken%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFullToken()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
