...
public class UpdateFlow200Response {
  ...
  public UpdateFlow200Response labels(@javax.annotation.Nullable List<Label> labels) {
    
    this.labels = labels;
    return this;
  }

  public UpdateFlow200Response addLabelsItem(Label labelsItem) {
    if (this.labels == null) {
  ...
  public UpdateFlow200Response variables(@javax.annotation.Nullable Object variables) {
