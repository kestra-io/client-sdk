...
| Run single test | `go test ./test_go_sdk -run TestName -v` |
...
| File | Purpose |
|------|---------|
| `go/go-sdk/test_go_sdk/api_flows_test.go` | Main tests |
| `go/go-sdk/test_go_sdk/common_test_setup.go` | Helpers |
| `go/go-sdk/test_go_sdk/api_executions_test.go` | Reference |
...
**Location:** `/Users/roman/Documents/git-repos/client-sdk/.agent-guide.md`
