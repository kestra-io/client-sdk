...
`func (o *PluginPluginElementMetadata) GetTitle() string`

GetTitle returns the Title field if non-nil, zero value otherwise.

### GetTitleOk

`func (o *PluginPluginElementMetadata) GetTitleOk() (*string, bool)`
...
`func (o *PluginPluginElementMetadata) SetTitle(v string)`

SetTitle sets Title field to given value.

### HasTitle

`func (o *PluginPluginElementMetadata) HasTitle() bool`

HasTitle returns a boolean if a field has been set.

### GetDescription

`func (o *PluginPluginElementMetadata) GetDescription() string`

GetDescription returns the Description field if non-nil, zero value otherwise.

### GetDescriptionOk

`func (o *PluginPluginElementMetadata) GetDescriptionOk() (*string, bool)`
...
`func (o *PluginPluginElementMetadata) SetDescription(v string)`

SetDescription sets Description field to given value.

### HasDescription

`func (o *PluginPluginElementMetadata) HasDescription() bool`
