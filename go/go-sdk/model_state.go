...
type State struct {
	...
	DurationOrComputeIt  *string        `json:"durationOrComputeIt,omitempty"`
...
// GetDurationOrComputeIt returns the DurationOrComputeIt field value if set, zero value otherwise.
func (o *State) GetDurationOrComputeIt() string {
	if o == nil || IsNil(o.DurationOrComputeIt) {
		var ret string
		return ret
	}
	return *o.DurationOrComputeIt
}

// GetDurationOrComputeItOk returns a tuple with the DurationOrComputeIt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *State) GetDurationOrComputeItOk() (*string, bool) {
	if o == nil || IsNil(o.DurationOrComputeIt) {
		return nil, false
	}
	return o.DurationOrComputeIt, true
}
...
// SetDurationOrComputeIt gets a reference to the given string and assigns it to the DurationOrComputeIt field.
func (o *State) SetDurationOrComputeIt(v string) {
	o.DurationOrComputeIt = &v
}
...
func (o State) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DurationOrComputeIt) {
		toSerialize["durationOrComputeIt"] = o.DurationOrComputeIt
	}
...
func (o *State) UnmarshalJSON(data []byte) (err error) {
	...
	*o = State(varState)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "durationOrComputeIt")
