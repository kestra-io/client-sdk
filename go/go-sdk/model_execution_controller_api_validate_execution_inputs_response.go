...
type ExecutionControllerApiValidateExecutionInputsResponse struct {
	...
	Checks               []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure  `json:"checks,omitempty"`
...
// SetChecks gets a reference to the given []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure and assigns it to the Checks field.
