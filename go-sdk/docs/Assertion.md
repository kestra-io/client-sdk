...
**EqualTo** | Pointer to **string** |  | [optional] 
**NotEqualTo** | Pointer to **string** |  | [optional] 
**GreaterThan** | Pointer to **string** |  | [optional] 
**GreaterThanOrEqualTo** | Pointer to **string** |  | [optional] 
**LessThan** | Pointer to **string** |  | [optional] 
**LessThanOrEqualTo** | Pointer to **string** |  | [optional] 
**In** | Pointer to **string** |  | [optional] 
**NotIn** | Pointer to **string** |  | [optional] 
**IsNull** | Pointer to **string** |  | [optional] 
**IsNotNull** | Pointer to **string** |  | [optional] 
