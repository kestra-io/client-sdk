...
// SetSUBMITTED gets a reference to the given int64 and assigns it to the SUBMITTED field.
...
// GetRESUBMITTED returns the RESUBMITTED field value if set, zero value otherwise.
func (o *DailyExecutionStatisticsExecutionCounts) GetRESUBMITTED() int64 {
	if o == nil || IsNil(o.RESUBMITTED) {
		var ret int64
		return ret
	}
	return *o.RESUBMITTED
}

// GetRESUBMITTEDOk returns a tuple with the RESUBMITTED field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DailyExecutionStatisticsExecutionCounts) GetRESUBMITTEDOk() (*int64, bool) {
	if o == nil || IsNil(o.RESUBMITTED) {
		return nil, false
	}
	return o.RESUBMITTED, true
}
...
// SetRESUBMITTED gets a reference to the given int64 and assigns it to the RESUBMITTED field.
...
func (o DailyExecutionStatisticsExecutionCounts) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RESUBMITTED) {
		toSerialize["RESUBMITTED"] = o.RESUBMITTED
	}
...
func (o *DailyExecutionStatisticsExecutionCounts) UnmarshalJSON(data []byte) (err error) {
	...
	*o = DailyExecutionStatisticsExecutionCounts(varDailyExecutionStatisticsExecutionCounts)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "RESUBMITTED")
