...
type ExecutionControllerExecutionResponse struct {
	...
	LoopRun NullableLoopRun `json:"loopRun,omitempty"`
...
func NewExecutionControllerExecutionResponse(id string, namespace string, flowId string, flowRevision int32, state State, originalId string, deleted bool, metadata ExecutionMetadata) *ExecutionControllerExecutionResponse {
...
// GetLoopRun returns the LoopRun field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ExecutionControllerExecutionResponse) GetLoopRun() LoopRun {
	if o == nil || IsNil(o.LoopRun.Get()) {
		var ret LoopRun
		return ret
	}
	return *o.LoopRun.Get()
}

// GetLoopRunOk returns a tuple with the LoopRun field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExecutionControllerExecutionResponse) GetLoopRunOk() (*LoopRun, bool) {
	if o == nil {
		return nil, false
	}
	return o.LoopRun.Get(), o.LoopRun.IsSet()
}

// HasLoopRun returns a boolean if a field has been set.
func (o *ExecutionControllerExecutionResponse) HasLoopRun() bool {
	if o != nil && o.LoopRun.IsSet() {
		return true
	}
...
// SetLoopRun gets a reference to the given NullableLoopRun and assigns it to the LoopRun field.
func (o *ExecutionControllerExecutionResponse) SetLoopRun(v LoopRun) {
	o.LoopRun.Set(&v)
}
// SetLoopRunNil sets the value for LoopRun to be an explicit nil
func (o *ExecutionControllerExecutionResponse) SetLoopRunNil() {
	o.LoopRun.Set(nil)
}

// UnsetLoopRun ensures that no value is present for LoopRun, not even an explicit nil
func (o *ExecutionControllerExecutionResponse) UnsetLoopRun() {
	o.LoopRun.Unset()
}
...
func (o ExecutionControllerExecutionResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.LoopRun.IsSet() {
		toSerialize["loopRun"] = o.LoopRun.Get()
	}
	if !IsNil(o.Url) {
