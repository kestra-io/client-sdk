...
func (o *AbstractUser) GetInstanceOwner() bool {
...
// and a boolean to check if the value has been set.
func (o *AbstractUser) GetInstanceOwnerOk() (*bool, bool) {
	if o == nil || IsNil(o.InstanceOwner) {
		return nil, false
	}
...
func (o *AbstractUser) HasInstanceOwner() bool {
	if o != nil && !IsNil(o.InstanceOwner) {
		return true
	}
...
func (o *AbstractUser) SetInstanceOwner(v bool) {
	o.InstanceOwner = &v
}
