...
func MapObjectObjectAsSLALabels(v *MapObjectObject) SLALabels {
	return SLALabels{
		MapObjectObject: v,
	}
}

// []stringAsSLALabels is a convenience function that returns []string wrapped in SLALabels
func ArrayOfStringAsSLALabels(v *[]string) SLALabels {
	return SLALabels{
		ArrayOfString: v,
	}
}
...
func (dst *SLALabels) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SLALabels)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SLALabels)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SLALabels) MarshalJSON() ([]byte, error) {
...
type NullableSLALabels struct {
	value *SLALabels
	isSet bool
}

func (v NullableSLALabels) Get() *SLALabels {
	return v.value
}

func (v *NullableSLALabels) Set(val *SLALabels) {
	v.value = val
	v.isSet = true
}

func (v NullableSLALabels) IsSet() bool {
	return v.isSet
}

func (v *NullableSLALabels) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSLALabels(val *SLALabels) *NullableSLALabels {
	return &NullableSLALabels{value: val, isSet: true}
}

func (v NullableSLALabels) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSLALabels) UnmarshalJSON(src []byte) error {
	v.isSet = true
