...
type TriggerControllerSetDisabledRequest struct {
	Triggers []TriggerControllerApiTriggerId `json:"triggers"`
...
func NewTriggerControllerSetDisabledRequest(triggers []TriggerControllerApiTriggerId, disabled bool) *TriggerControllerSetDisabledRequest {
...
func (o *TriggerControllerSetDisabledRequest) GetTriggers() []TriggerControllerApiTriggerId {
	if o == nil {
		var ret []TriggerControllerApiTriggerId
		return ret
	}
...
func (o *TriggerControllerSetDisabledRequest) GetTriggersOk() ([]TriggerControllerApiTriggerId, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TriggerControllerSetDisabledRequest) SetTriggers(v []TriggerControllerApiTriggerId) {
	o.Triggers = v
}
