...
type UserUsage struct {
	...
	PasswordlessCount int64 `json:"passwordlessCount"`
...
func NewUserUsage(count int64, apiKeyCount int64, oidcCount int64, basicAuthCount int64, passwordlessCount int64) *UserUsage {
	this := UserUsage{}
	this.Count = count
...
// GetPasswordlessCount returns the PasswordlessCount field value
func (o *UserUsage) GetPasswordlessCount() int64 {
	if o == nil {
		var ret int64
		return ret
	}

	return o.PasswordlessCount
}

// GetPasswordlessCountOk returns a tuple with the PasswordlessCount field value
// and a boolean to check if the value has been set.
func (o *UserUsage) GetPasswordlessCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PasswordlessCount, true
}

// SetPasswordlessCount sets field value
func (o *UserUsage) SetPasswordlessCount(v int64) {
	o.PasswordlessCount = v
}
...
func (o UserUsage) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["passwordlessCount"] = o.PasswordlessCount
...
func (o *UserUsage) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UserUsage(varUserUsage)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "passwordlessCount")
