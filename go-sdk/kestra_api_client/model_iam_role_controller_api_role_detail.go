...
func (o *IAMRoleControllerApiRoleDetail) GetPermissions() ListPermissions200Response {
...
// and a boolean to check if the value has been set.
func (o *IAMRoleControllerApiRoleDetail) GetPermissionsOk() (*ListPermissions200Response, bool) {
	if o == nil || IsNil(o.Permissions) {
		return nil, false
	}
...
func (o *IAMRoleControllerApiRoleDetail) SetPermissions(v ListPermissions200Response) {
	o.Permissions = &v
}
