...
type ExecutionControllerApiValidateExecutionInputsResponse struct {
	...
	Checks []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure `json:"checks"`
...
func NewExecutionControllerApiValidateExecutionInputsResponse(id string, namespace string, inputs []ExecutionControllerApiValidateExecutionInputsResponseApiInputAndValue, checks []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure) *ExecutionControllerApiValidateExecutionInputsResponse {
...
func (o *ExecutionControllerApiValidateExecutionInputsResponse) GetChecks() []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure {
	if o == nil {
		var ret []ExecutionControllerApiValidateExecutionInputsResponseApiCheckFailure
		return ret
	}
