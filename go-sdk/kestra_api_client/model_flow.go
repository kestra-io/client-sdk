...
// and a boolean to check if the value has been set.
func (o *Flow) GetLabelsOk() (*MapObjectObject, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *Flow) SetLabels(v MapObjectObject) {
	o.Labels = &v
}
...
// and a boolean to check if the value has been set.
func (o *Flow) GetChecksOk() ([]Check, bool) {
	if o == nil || IsNil(o.Checks) {
		return nil, false
	}
