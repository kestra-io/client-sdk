...
func NewCheck(when string, message string) *Check {
	this := Check{}
	this.When = when
...
func (o *Check) HasCondition() bool {
	if o != nil && !IsNil(o.Condition) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Check) GetWhenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.When, true
