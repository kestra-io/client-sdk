...
Deprecated: the underlying route GET /api/v1/{tenant}/namespaces/{namespace}/secrets was
removed in Kestra 2.0 and now answers 403. Use KestraClient.Namespaces().ListNamespaceSecrets
(namespace-scoped) or KestraClient.Namespaces().ListSecrets (cross-namespace), which call the
replacement GET /api/v1/{tenant}/secrets.
*/
...
//
// Deprecated: the underlying route was removed in Kestra 2.0 and now answers 403; use
// KestraClient.Namespaces().ListNamespaceSecrets or KestraClient.Namespaces().ListSecrets.
