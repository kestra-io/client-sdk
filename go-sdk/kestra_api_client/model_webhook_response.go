...
func (o *WebhookResponse) GetOutputs() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *WebhookResponse) GetOutputsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Outputs) {
...
func (o *WebhookResponse) SetOutputs(v map[string]interface{}) {
	o.Outputs = v
}
