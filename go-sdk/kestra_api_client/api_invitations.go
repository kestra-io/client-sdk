...
func (r ApiCreateInvitationRequest) GetTenant() string {
	return r.tenant
}
func (r ApiCreateInvitationRequest) GetIAMInvitationControllerApiInvitationCreateRequest() *IAMInvitationControllerApiInvitationCreateRequest {
	return r.iAMInvitationControllerApiInvitationCreateRequest
}
...
func (r ApiDeleteInvitationRequest) GetId() string {
	return r.id
}
func (r ApiDeleteInvitationRequest) GetTenant() string {
	return r.tenant
}
...
type ApiInvitationRequest struct {
	ctx        context.Context
	ApiService *InvitationsAPIService
	id         string
	tenant     string
...
func (r ApiInvitationRequest) GetId() string {
	return r.id
}
func (r ApiInvitationRequest) GetTenant() string {
	return r.tenant
}

func (r ApiInvitationRequest) Execute() (*IAMInvitationControllerApiInvitationDetail, *http.Response, error) {
	return r.ApiService.InvitationExecute(r)
}

/*
Invitation Retrieve an invitation
...
Retrieves the invitation by its ID, including the invitation link.
	...
	@param id The id of the invitation
	@param tenant
	@return ApiInvitationRequest
*/
func (a *InvitationsAPIService) Invitation(ctx context.Context, id string, tenant string) ApiInvitationRequest {
	return ApiInvitationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *InvitationsAPIService) InvitationExecute(r ApiInvitationRequest) (*IAMInvitationControllerApiInvitationDetail, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InvitationsAPIService.Invitation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiListInvitationsByEmailRequest) GetEmail() string {
	return r.email
}
func (r ApiListInvitationsByEmailRequest) GetTenant() string {
	return r.tenant
}
...
// Filters
func (r ApiSearchInvitationsRequest) Filters(filters []QueryFilter) ApiSearchInvitationsRequest {
	r.filters = &filters
	return r
}
...
func (r ApiSearchInvitationsRequest) GetPage() *int32 {
	return r.page
}
func (r ApiSearchInvitationsRequest) GetSize() *int32 {
	return r.size
}
func (r ApiSearchInvitationsRequest) GetFilters() *[]QueryFilter {
	return r.filters
}
func (r ApiSearchInvitationsRequest) GetTenant() string {
	return r.tenant
}
func (r ApiSearchInvitationsRequest) GetSort() *[]string {
	return r.sort
}
