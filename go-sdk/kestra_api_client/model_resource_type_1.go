...
// checks if the ResourceType1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceType1{}
...
type _ResourceType1 ResourceType1
...
func (o ResourceType1) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceType1) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceType1 := _ResourceType1{}

	err = json.Unmarshal(data, &varResourceType1)

	if err != nil {
		return err
	}

	*o = ResourceType1(varResourceType1)
