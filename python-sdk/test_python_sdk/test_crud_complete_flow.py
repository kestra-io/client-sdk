...
def test_crud_complete_flow():
    api_client = kestra_client()


    tenant = 'main'
    flow_id = 'sdk-complex-flow'
    ...
    api_client.flows.create_flow(
        tenant,
        body
    )
    print("Created")

    api_client.flows.get_flow(
        id=flow_id,
        namespace=namespace,
        tenant=tenant,
        allow_deleted=False,
    ...
    api_client.flows.list_flow_revisions(
        tenant=tenant,
        namespace=namespace,
        id=flow_id
    )
