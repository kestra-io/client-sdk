...
------------- | ------------- | -------------
[**autocomplete_roles**](IAMRoleApi.md#autocomplete_roles) | **POST** /api/v1/{tenant}/roles/autocomplete | List roles for autocomplete
[**create_role**](IAMRoleApi.md#create_role) | **POST** /api/v1/{tenant}/roles | Create a role
[**delete_role**](IAMRoleApi.md#delete_role) | **DELETE** /api/v1/{tenant}/roles/{id} | Delete a role
[**get_role**](IAMRoleApi.md#get_role) | **GET** /api/v1/{tenant}/roles/{id} | Retrieve a role
[**list_roles_from_given_ids**](IAMRoleApi.md#list_roles_from_given_ids) | **POST** /api/v1/{tenant}/roles/ids | List roles by ids
[**search_roles**](IAMRoleApi.md#search_roles) | **GET** /api/v1/{tenant}/roles/search | Search for roles
[**update_role**](IAMRoleApi.md#update_role) | **PUT** /api/v1/{tenant}/roles/{id} | Update a role
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    api_instance = kestrapy.IAMRoleApi(api_client)
    ...
    try:
        ...
        print("The response of IAMRoleApi->autocomplete_roles:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->autocomplete_roles: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IAMRoleApi->create_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->create_role: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling IAMRoleApi->delete_role: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IAMRoleApi->get_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->get_role: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IAMRoleApi->list_roles_from_given_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->list_roles_from_given_ids: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IAMRoleApi->search_roles:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->search_roles: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IAMRoleApi->update_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IAMRoleApi->update_role: %s\n" % e)
```
