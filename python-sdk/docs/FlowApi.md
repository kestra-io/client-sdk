...
------------- | ------------- | -------------
[**bulk_update_flows**](FlowApi.md#bulk_update_flows) | **POST** /api/v1/{tenant}/flows/bulk | Update from multiples yaml sources
[**create_flow**](FlowApi.md#create_flow) | **POST** /api/v1/{tenant}/flows | Create a flow from yaml source
[**delete_flow**](FlowApi.md#delete_flow) | **DELETE** /api/v1/{tenant}/flows/{namespace}/{id} | Delete a flow
[**delete_flows_by_ids**](FlowApi.md#delete_flows_by_ids) | **DELETE** /api/v1/{tenant}/flows/delete/by-ids | Delete flows by their IDs.
[**delete_flows_by_query**](FlowApi.md#delete_flows_by_query) | **DELETE** /api/v1/{tenant}/flows/delete/by-query | Delete flows returned by the query parameters.
[**disable_flows_by_ids**](FlowApi.md#disable_flows_by_ids) | **POST** /api/v1/{tenant}/flows/disable/by-ids | Disable flows by their IDs.
[**disable_flows_by_query**](FlowApi.md#disable_flows_by_query) | **POST** /api/v1/{tenant}/flows/disable/by-query | Disable flows returned by the query parameters.
[**enable_flows_by_ids**](FlowApi.md#enable_flows_by_ids) | **POST** /api/v1/{tenant}/flows/enable/by-ids | Enable flows by their IDs.
[**enable_flows_by_query**](FlowApi.md#enable_flows_by_query) | **POST** /api/v1/{tenant}/flows/enable/by-query | Enable flows returned by the query parameters.
[**export_flows_by_ids**](FlowApi.md#export_flows_by_ids) | **POST** /api/v1/{tenant}/flows/export/by-ids | Export flows as a ZIP archive of yaml sources.
[**export_flows_by_query**](FlowApi.md#export_flows_by_query) | **GET** /api/v1/{tenant}/flows/export/by-query | Export flows as a ZIP archive of yaml sources.
[**generate_flow_graph**](FlowApi.md#generate_flow_graph) | **GET** /api/v1/{tenant}/flows/{namespace}/{id}/graph | Generate a graph for a flow
[**generate_flow_graph_from_source**](FlowApi.md#generate_flow_graph_from_source) | **POST** /api/v1/{tenant}/flows/graph | Generate a graph for a flow source
[**get_flow**](FlowApi.md#get_flow) | **GET** /api/v1/{tenant}/flows/{namespace}/{id} | Get a flow
[**get_flow_dependencies**](FlowApi.md#get_flow_dependencies) | **GET** /api/v1/{tenant}/flows/{namespace}/{id}/dependencies | Get flow dependencies
[**get_task_from_flow**](FlowApi.md#get_task_from_flow) | **GET** /api/v1/{tenant}/flows/{namespace}/{id}/tasks/{taskId} | Get a flow task
[**import_flows**](FlowApi.md#import_flows) | **POST** /api/v1/{tenant}/flows/import |     Import flows as a ZIP archive of yaml sources or a multi-objects YAML file.     When sending a Yaml that contains one or more flows, a list of index is returned.     When sending a ZIP archive, a list of files that couldn&#39;t be imported is returned. 
[**list_distinct_namespaces**](FlowApi.md#list_distinct_namespaces) | **GET** /api/v1/{tenant}/flows/distinct-namespaces | List all distinct namespaces
[**list_flow_revisions**](FlowApi.md#list_flow_revisions) | **GET** /api/v1/{tenant}/flows/{namespace}/{id}/revisions | Get revisions for a flow
[**list_flows_by_namespace**](FlowApi.md#list_flows_by_namespace) | **GET** /api/v1/{tenant}/flows/{namespace} | Retrieve all flows from a given namespace
[**search_flows**](FlowApi.md#search_flows) | **GET** /api/v1/{tenant}/flows/search | Search for flows
[**search_flows_by_source_code**](FlowApi.md#search_flows_by_source_code) | **GET** /api/v1/{tenant}/flows/source | Search for flows source code
[**update_flow**](FlowApi.md#update_flow) | **PUT** /api/v1/{tenant}/flows/{namespace}/{id} | Update a flow
[**update_flows_in_namespace_from_json**](FlowApi.md#update_flows_in_namespace_from_json) | **POST** /api/v1/{tenant}/flows/{namespace} | Update a complete namespace from json object
[**update_task**](FlowApi.md#update_task) | **PATCH** /api/v1/{tenant}/flows/{namespace}/{id}/{taskId} | Update a single task on a flow
[**validate_flows**](FlowApi.md#validate_flows) | **POST** /api/v1/{tenant}/flows/validate | Validate a list of flows
[**validate_task**](FlowApi.md#validate_task) | **POST** /api/v1/{tenant}/flows/validate/task | Validate a task
[**validate_trigger**](FlowApi.md#validate_trigger) | **POST** /api/v1/{tenant}/flows/validate/trigger | Validate trigger
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    api_instance = kestrapy.FlowApi(api_client)
    ...
    try:
        ...
        print("The response of FlowApi->bulk_update_flows:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->bulk_update_flows: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->delete_flows_by_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->delete_flows_by_ids: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->delete_flows_by_query:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->delete_flows_by_query: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->disable_flows_by_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->disable_flows_by_ids: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->disable_flows_by_query:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->disable_flows_by_query: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->enable_flows_by_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->enable_flows_by_ids: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->enable_flows_by_query:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->enable_flows_by_query: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->export_flows_by_ids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->export_flows_by_ids: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->export_flows_by_query:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->export_flows_by_query: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->generate_flow_graph:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->generate_flow_graph: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->generate_flow_graph_from_source:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->generate_flow_graph_from_source: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->get_flow:\n")
        pprint(api_response)
    except Exception as e:
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->get_flow_dependencies:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->get_flow_dependencies: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->get_task_from_flow:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->get_task_from_flow: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->import_flows:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->import_flows: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->list_distinct_namespaces:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->list_distinct_namespaces: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->list_flow_revisions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->list_flow_revisions: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->list_flows_by_namespace:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->list_flows_by_namespace: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->search_flows_by_source_code:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->search_flows_by_source_code: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->update_flows_in_namespace_from_json:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->update_flows_in_namespace_from_json: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->update_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->update_task: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->validate_flows:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->validate_flows: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->validate_task:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->validate_task: %s\n" % e)
```
...
with kestrapy.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FlowApi->validate_trigger:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowApi->validate_trigger: %s\n" % e)
```
