...
public class Flow {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, namespace, revision, updated, description, inputs, outputs, disabled, labels, variables, workerGroup, deleted, _finally, tasks, errors, afterExecution, triggers, concurrency, retry, sla, checks);
  }
