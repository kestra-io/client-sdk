...
/**
 * Holds a task/trigger `assets.inputs`: a list of asset identifiers or a `{{ }}` expression string.
 *
 ...
 */
@JsonDeserialize(as = PropertyListAssetIdentifier.Value.class)
public interface PropertyListAssetIdentifier {

  /**
   * Wrap a raw value (a {@code String} expression, a {@code Map}, a
   * {@code List}, ...) as a {@link PropertyListAssetIdentifier}.
   */
  static PropertyListAssetIdentifier of(Object value) {
  ...
  final class Value implements PropertyListAssetIdentifier {
