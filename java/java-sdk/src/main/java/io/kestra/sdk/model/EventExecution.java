 ...
 */
@JsonPropertyOrder({
  EventExecution.JSON_PROPERTY_DATA,
  EventExecution.JSON_PROPERTY_ID,
  EventExecution.JSON_PROPERTY_NAME,
  EventExecution.JSON_PROPERTY_COMMENT,
...
public class EventExecution {
  ...
  public boolean equals(Object o) {
    ...
    EventExecution eventExecution = (EventExecution) o;
    return Objects.equals(this.data, eventExecution.data) &&
        Objects.equals(this.id, eventExecution.id) &&
        Objects.equals(this.name, eventExecution.name) &&
        Objects.equals(this.comment, eventExecution.comment) &&
        Objects.equals(this.retry, eventExecution.retry);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventExecution {\n");
