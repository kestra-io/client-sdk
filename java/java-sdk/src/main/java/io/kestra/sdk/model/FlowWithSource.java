...
@JsonPropertyOrder({
  ...
  FlowWithSource.JSON_PROPERTY_UPDATED,
...
public class FlowWithSource {
  ...
  public FlowWithSource updated(@jakarta.annotation.Nullable OffsetDateTime updated) {
  ...
  public FlowWithSource checks(@jakarta.annotation.Nullable List<Check> checks) {
    
    this.checks = checks;
    return this;
  }

  public FlowWithSource addChecksItem(Check checksItem) {
    if (this.checks == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, flowWithSource.id) &&
        ...
        Objects.equals(this.updated, flowWithSource.updated) &&
