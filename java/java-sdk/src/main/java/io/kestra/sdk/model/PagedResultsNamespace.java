...
public class PagedResultsNamespace {
  ...
  @jakarta.annotation.Nonnull  private List<Namespace> results = new ArrayList<>();
  ...
  public PagedResultsNamespace results(@jakarta.annotation.Nonnull List<Namespace> results) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setResults(@jakarta.annotation.Nonnull List<Namespace> results) {
    this.results = results;
  }

  public PagedResultsNamespace total(@jakarta.annotation.Nonnull Long total) {
