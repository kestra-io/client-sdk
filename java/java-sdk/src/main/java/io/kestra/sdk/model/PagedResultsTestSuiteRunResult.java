...
public class PagedResultsTestSuiteRunResult {
  ...
  @jakarta.annotation.Nonnull  private List<TestSuiteRunResult> results = new ArrayList<>();
  ...
  public PagedResultsTestSuiteRunResult results(@jakarta.annotation.Nonnull List<TestSuiteRunResult> results) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setResults(@jakarta.annotation.Nonnull List<TestSuiteRunResult> results) {
    this.results = results;
  }

  public PagedResultsTestSuiteRunResult total(@jakarta.annotation.Nonnull Long total) {
