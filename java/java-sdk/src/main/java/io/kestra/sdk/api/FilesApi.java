...
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.16.0")public class FilesApi extends BaseApi {
   ...
   */
  public void createNamespaceDirectory(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void createNamespaceDirectory(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path, Map<String, String> additionalHeaders) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void createNamespaceFile(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable File fileContent) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void createNamespaceFile(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable File fileContent, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteFileDirectory(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteFileDirectory(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public byte[] exportNamespaceFiles(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public byte[] exportNamespaceFiles(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @param path The internal storage uri (required)
   * @param tenant  (required)
   * @param revision The revision, if not provided, the latest revision will be returned (optional)
   * @return File
   * @throws ApiException if fails to make API call
   */
  public File fileContent(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable Integer revision) throws ApiException {
    return this.fileContent(namespace, path, tenant, revision, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public File fileContent(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String path, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable Integer revision, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'namespace' is set
    if (namespace == null) {
      throw new ApiException(400, "Missing the required parameter 'namespace' when calling fileContent");
    }
    
    // verify the required parameter 'path' is set
    if (path == null) {
      throw new ApiException(400, "Missing the required parameter 'path' when calling fileContent");
    }
    
    // verify the required parameter 'tenant' is set
    if (tenant == null) {
      throw new ApiException(400, "Missing the required parameter 'tenant' when calling fileContent");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public FileAttributes fileMetadatas(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path) throws ApiException {
    return this.fileMetadatas(namespace, tenant, path, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public FileAttributes fileMetadatas(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'namespace' is set
    if (namespace == null) {
      throw new ApiException(400, "Missing the required parameter 'namespace' when calling fileMetadatas");
    }
    
    // verify the required parameter 'tenant' is set
    if (tenant == null) {
      throw new ApiException(400, "Missing the required parameter 'tenant' when calling fileMetadatas");
    }
   ...
   * @param tenant  (required)
   * @param path The internal storage uri (optional)
   * @return List&lt;NamespaceFileRevision&gt;
   * @throws ApiException if fails to make API call
   */
  public List<NamespaceFileRevision> fileRevisions(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path) throws ApiException {
    return this.fileRevisions(namespace, tenant, path, Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public List<NamespaceFileRevision> fileRevisions(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'namespace' is set
    if (namespace == null) {
      throw new ApiException(400, "Missing the required parameter 'namespace' when calling fileRevisions");
    }
    
    // verify the required parameter 'tenant' is set
    if (tenant == null) {
      throw new ApiException(400, "Missing the required parameter 'tenant' when calling fileRevisions");
    }
    
    // create path and map variables
    String localVarPath = "/api/v1/{tenant}/namespaces/{namespace}/files/revisions"
      .replaceAll("\\{" + "namespace" + "\\}", apiClient.escapeString(apiClient.parameterToString(namespace)))
      .replaceAll("\\{" + "tenant" + "\\}", apiClient.escapeString(apiClient.parameterToString(tenant)));
    ...
    TypeReference<List<NamespaceFileRevision>> localVarReturnType = new TypeReference<List<NamespaceFileRevision>>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
   ...
   * @throws ApiException if fails to make API call
   */
  public List<FileAttributes> listNamespaceDirectoryFiles(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<FileAttributes> listNamespaceDirectoryFiles(@jakarta.annotation.Nonnull String namespace, @jakarta.annotation.Nonnull String tenant, @jakarta.annotation.Nullable String path, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = null;
