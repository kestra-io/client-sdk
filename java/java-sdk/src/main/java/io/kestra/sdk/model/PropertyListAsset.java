...
/**
 * Holds a task/trigger `assets.outputs`: a list of assets or a `{{ }}` expression string.
 *
 ...
 */
@JsonDeserialize(as = PropertyListAsset.Value.class)
public interface PropertyListAsset {

  /**
   * Wrap a raw value (a {@code String} expression, a {@code Map}, a
   * {@code List}, ...) as a {@link PropertyListAsset}.
   */
  static PropertyListAsset of(Object value) {
    return new Value(value);
  }

  /** The raw value, serialized and deserialized as-is. */
  final class Value implements PropertyListAsset {
