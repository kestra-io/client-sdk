 ...
 */
@JsonPropertyOrder({
  IAMBindingControllerApiBindingGroup.JSON_PROPERTY_ID,
...
public class IAMBindingControllerApiBindingGroup {
  ...
  public boolean equals(Object o) {
    ...
    IAMBindingControllerApiBindingGroup iaMBindingControllerApiBindingGroup = (IAMBindingControllerApiBindingGroup) o;
    return Objects.equals(this.id, iaMBindingControllerApiBindingGroup.id) &&
        Objects.equals(this.name, iaMBindingControllerApiBindingGroup.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class IAMBindingControllerApiBindingGroup {\n");
