...
public class NamespaceAllowedTrigger {
  ...
  public NamespaceAllowedTrigger namespace(@jakarta.annotation.Nonnull String namespace) {
  ...
  public NamespaceAllowedTrigger flowId(@jakarta.annotation.Nullable String flowId) {
